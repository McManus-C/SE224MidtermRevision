...
export const AdBanner: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-8 print:hidden">
      ...
      */}
      <div className="w-full bg-slate-100 border border-slate-200 rounded-lg p-4 min-h-[120px] relative overflow-hidden text-center">
        <p className="text-[10px] text-gray-400 uppercase tracking-widest mb-2 z-10 relative">Advertisement</p>
        ...
        */}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-300 pointer-events-none z-0">
          <span className="text-xs mt-4">Google AdSense Space</span>
